...
namespace QuanLyBanHang_DAIII {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class KhachHangDataTable : global::System.Data.TypedTableBase<KhachHangRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public KhachHangRow AddKhachHangRow(string MaKH, string HoTenKH, string DiaChi, string SoDienThoai, string Email) {
...
namespace QuanLyBanHang_DAIII.DataSet1TableAdapters {
    ...
    public partial class KhachHangTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[KhachHang] WHERE (([MaKH] = @Original_MaKH) AND ((@IsNull_HoTenKH = 1 AND [HoTenKH] IS NULL) OR ([HoTenKH] = @Original_HoTenKH)) AND ((@IsNull_DiaChi = 1 AND [DiaChi] IS NULL) OR ([DiaChi] = @Original_DiaChi)) AND ((@IsNull_SoDienThoai = 1 AND [SoDienThoai] IS NULL) OR ([SoDienThoai] = @Original_SoDienThoai)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[KhachHang] ([MaKH], [HoTenKH], [DiaChi], [SoDienThoai], [Email" +
                "]) VALUES (@MaKH, @HoTenKH, @DiaChi, @SoDienThoai, @Email);\r\nSELECT MaKH, HoTenK" +
                "H, DiaChi, SoDienThoai, Email FROM KhachHang WHERE (MaKH = @MaKH)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[KhachHang] SET [MaKH] = @MaKH, [HoTenKH] = @HoTenKH, [DiaChi] = @DiaChi, [SoDienThoai] = @SoDienThoai, [Email] = @Email WHERE (([MaKH] = @Original_MaKH) AND ((@IsNull_HoTenKH = 1 AND [HoTenKH] IS NULL) OR ([HoTenKH] = @Original_HoTenKH)) AND ((@IsNull_DiaChi = 1 AND [DiaChi] IS NULL) OR ([DiaChi] = @Original_DiaChi)) AND ((@IsNull_SoDienThoai = 1 AND [SoDienThoai] IS NULL) OR ([SoDienThoai] = @Original_SoDienThoai)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)));
SELECT MaKH, HoTenKH, DiaChi, SoDienThoai, Email FROM KhachHang WHERE (MaKH = @MaKH)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT MaKH, HoTenKH, DiaChi, SoDienThoai, Email FROM dbo.KhachHang";
        ...
        public virtual int Delete(string Original_MaKH, string Original_HoTenKH, string Original_DiaChi, string Original_SoDienThoai, string Original_Email) {
        ...
        public virtual int Insert(string MaKH, string HoTenKH, string DiaChi, string SoDienThoai, string Email) {
            if ((MaKH == null)) {
        ...
        public virtual int Update(string MaKH, string HoTenKH, string DiaChi, string SoDienThoai, string Email, string Original_MaKH, string Original_HoTenKH, string Original_DiaChi, string Original_SoDienThoai, string Original_Email) {
            if ((MaKH == null)) {
                throw new global::System.ArgumentNullException("MaKH");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string HoTenKH, string DiaChi, string SoDienThoai, string Email, string Original_MaKH, string Original_HoTenKH, string Original_DiaChi, string Original_SoDienThoai, string Original_Email) {
            return this.Update(Original_MaKH, HoTenKH, DiaChi, SoDienThoai, Email, Original_MaKH, Original_HoTenKH, Original_DiaChi, Original_SoDienThoai, Original_Email);
        }
    }
